 ...
 * @author amrjlg
 **/
public class ByteSpinedNodeBuilder
        extends SpinedBuffer.OfByte
        implements NodeBuilder.OfByte, Node.OfByte {
    ...
    @Override
    public void copyInto(byte[] array, int offset) throws IndexOutOfBoundsException {
        assert !building : "during building";
