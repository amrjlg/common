...
public abstract class SizedCollectorTask<Input, Output, TypeSink extends Sink<Output>, Task extends SizedCollectorTask<Input, Output, TypeSink, Task>>
    ...
    public static final class OfByte<Input> extends SizedCollectorTask<Input, Byte, Sink.OfByte, OfByte<Input>>
    ...
    public static final class OfChar<Input> extends SizedCollectorTask<Input, Character, Sink.OfChar, OfChar<Input>>
    ...
    public static final class OfLong<Input> extends SizedCollectorTask<Input, Long, Sink.OfLong, OfLong<Input>>
    ...
    public static final class OfFloat<Input> extends SizedCollectorTask<Input, Float, Sink.OfFloat, OfFloat<Input>>
