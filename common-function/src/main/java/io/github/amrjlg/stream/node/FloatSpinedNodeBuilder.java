 ...
 * @author amrjlg
 **/
public class FloatSpinedNodeBuilder
        extends SpinedBuffer.OfFloat
        implements NodeBuilder.OfFloat, Node.OfFloat {
    ...
    @Override
    public void copyInto(float[] array, int offset) throws IndexOutOfBoundsException {
        assert !building : "during building";
